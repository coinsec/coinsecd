...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "coinsec:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			encoded: "coinsec:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixCoinsec,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixCoinsec)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixCoinsec,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "coinsec:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			encoded: "coinsec:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixCoinsec,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32PrefixCoinsec,
			expectedPrefix: util.Bech32PrefixCoinsec,
		},
		{
			name:    "testnet p2pk",
			addr:    "coinsectest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			encoded: "coinsectest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixCoinsecTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixCoinsecTest)
			},
			passedPrefix:   util.Bech32PrefixCoinsecTest,
			expectedPrefix: util.Bech32PrefixCoinsecTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "coinsec:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			encoded: "coinsec:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			valid:   true,
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixCoinsec)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixCoinsec,
		},
		...
		},
		{
			...
			addr:           "coinsec:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixCoinsec,
			expectedPrefix: util.Bech32PrefixCoinsec,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "coinsec:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			encoded: "coinsec:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			valid:   true,
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixCoinsec)
			},
			passedPrefix:   util.Bech32PrefixCoinsec,
			expectedPrefix: util.Bech32PrefixCoinsec,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "coinsec:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			encoded: "coinsec:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixCoinsec,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixCoinsec)
			},
			passedPrefix:   util.Bech32PrefixCoinsec,
			expectedPrefix: util.Bech32PrefixCoinsec,
		},
		{
			name:    "testnet p2sh",
			addr:    "coinsectest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			encoded: "coinsectest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixCoinsecTest,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixCoinsecTest)
			},
			passedPrefix:   util.Bech32PrefixCoinsecTest,
			expectedPrefix: util.Bech32PrefixCoinsecTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"coinsecsim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvymmnd3gh8",
			util.Bech32PrefixCoinsecSim,
			"unknown address type",
		},
		{
			"coinsecsim:raskzcg58mth0an",
			util.Bech32PrefixCoinsecSim,
			"unknown address type",
		},
		{
			"coinsectest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsy0xez0tzw",
			util.Bech32PrefixCoinsec,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"coinsec", util.Bech32PrefixCoinsec, false},
		{"coinsectest", util.Bech32PrefixCoinsecTest, false},
		{"coinsecsim", util.Bech32PrefixCoinsecSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixCoinsec, "coinsec"},
		{util.Bech32PrefixCoinsecTest, "coinsectest"},
		{util.Bech32PrefixCoinsecSim, "coinsecsim"},
		{util.Bech32PrefixUnknown, ""},
	}
