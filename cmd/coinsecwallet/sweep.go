...
func sweep(conf *sweepConfig) error {
	...
	publicKeybytes, err := libcoinsecwallet.PublicKeyFromPrivateKey(privateKeyBytes)
	if err != nil {
		return err
	}
	...
	UTXOs, err := libcoinsecwallet.CoinsecwalletdUTXOsTolibcoinsecwalletUTXOs(getExternalSpendableUTXOsResponse.Entries)
	if err != nil {
		return err
	}
