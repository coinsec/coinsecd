...
const miningAddress = "coinsecdev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfkuhy0zmax"
...
func runDAATest(t *testing.T, testName string, runDuration time.Duration,
	...
	tearDownCoinsecd := common.RunCoinsecdForTesting(t, "coinsecd-daa-test", rpcAddress)
	defer tearDownCoinsecd()
