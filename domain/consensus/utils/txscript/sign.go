...
// SignatureScript creates an input signature script for tx to spend SEC sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend SEC sent
