...
// Params defines a Coinsec network by its parameters. These parameters may be
// used by Coinsec applications to differentiate networks as well as addresses
...
// MainnetParams defines the network parameters for the main Coinsec network.
var MainnetParams = Params{
	...
	Prefix: util.Bech32PrefixCoinsec,
...
// TestnetParams defines the network parameters for the test Coinsec network.
var TestnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixCoinsecTest,
...
// SimnetParams defines the network parameters for the simulation test Coinsec
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixCoinsecSim,
...
// DevnetParams defines the network parameters for the development Coinsec network.
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixCoinsecDev,
...
// ErrDuplicateNet describes an error where the parameters for a Coinsec
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Coinsec network")

var registeredNets = make(map[appmessage.CoinsecNet]struct{})

// Register registers the network parameters for a Coinsec network. This may
